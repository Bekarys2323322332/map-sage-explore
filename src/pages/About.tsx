      ...
      <div className="flex-1 flex flex-col pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 max-w-4xl mx-auto w-full space-y-12 animate-fade-in">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground">{t("about_description")}</p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="bg-card/80 backdrop-blur-md rounded-2xl p-6 border border-border/50 space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">{t("mission_description")}</p>
            </div>
            ...
            <div className="bg-card/80 backdrop-blur-md rounded-2xl p-6 border border-border/50 space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">{t("interactive_description")}</p>
            </div>
            ...
            <div className="bg-card/80 backdrop-blur-md rounded-2xl p-6 border border-border/50 space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">{t("cultural_description")}</p>
            </div>
            ...
            <div className="bg-card/80 backdrop-blur-md rounded-2xl p-6 border border-border/50 space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">{t("educational_description")}</p>
            </div>
          </div>
        </div>
      </div>
