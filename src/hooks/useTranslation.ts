export const useTranslation = (language: string) => {
  ...
  const translationsKZ: Record<string, string> = {
    ...
    about_description:
      "Орталық Азияның бай мәдени мұрасын бұрын-соңды болмаған тәсілмен ашыңыз. NomadMap Қазақстан, Өзбекстан, Қырғызстан, Тәжікстан және Түрікменстанның тарихын, дәстүрлерін және оқиғаларын интерактивті әрі көрнекі түрде көрсетеді.",
