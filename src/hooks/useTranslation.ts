export const useTranslation = (language: string) => {
  ...
  const translationsKZ: Record<string, string> = {
    ...
    // About page (Kazakh)
      ...
      about_description: "Орталық Азияның бай мәдени мұрасын бұрын-соңды болмаған тәсілмен ашыңыз. TengriMap Қазақстан, Өзбекстан, Қырғызстан, Тәжікстан және Түрікменстанның тарихын, дәстүрлерін және оқиғаларын интерактивті әрі көрнекі түрде көрсетеді.",
      our_mission: "Біздің миссиямыз",
      mission_description: "Орталық Азияның әртүрлі мәдениеттерін, тарихын және дәстүрлерін сақтап, ерекше оқиғаларды бөлісу арқылы осы аймақтың құндылықтарын дәріптеу.",
      interactive_experience: "Интерактивті тәжірибе",
      interactive_description: "Біздің интерактивті картамыз арқылы әрбір елдің тарихи орындарын, мәдени ескерткіштерін және дәстүрлерін зерттеңіз.",
      cultural_connection: "Мәдени байланыс",
      cultural_description: "Жібек жолындағы оқиғалармен, адамдармен және мұрамен танысып, бұл ұлттардың жаһандық мәдениет пен тарихқа әсерін түсініңіз.",
      educational_insight: "Білім беру мүмкіндігі",
      educational_description: "Ежелгі өркениеттерден қазіргі заманғы тәжірибелерге дейінгі білімді AI қуатымен жұмыс істейтін ресурстар мен толық нұсқаулықтар арқылы үйреніп, мәдениетті барлығына қолжетімді етіңіз.",
